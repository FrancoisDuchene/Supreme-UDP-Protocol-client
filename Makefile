...
HFILES = packet_interface.h sender.h general.h init_connexion.h read_write_loop_final.h window.h pkt_builder.h
COMMONCFILES = packet_implem.c sender.c init_connexion.c read_write_loop_final.c utils.c window.c pkt_builder.c
